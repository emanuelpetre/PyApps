...
app.config['MAIL_DEFAULT_SENDER'] = 'foaiedeparcurs.baumit@gmail.com'    #os.environ.get('MAIL_DEFAULT_SENDER')
...
def forgot():
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            # Send email
            try:
                msg = Message('Resetare parolă Foaie Parcurs', sender='foaiedeparcurs.baumit@gmail.com', recipients=[email])
